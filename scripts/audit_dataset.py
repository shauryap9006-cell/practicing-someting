...
val_ds = build_v2_dataset(
    db, vocab, str(val_start_dt), str(bench_start_dt - datetime.timedelta(days=1))
)
...
old_train_start_dt = max(
    datetime.date.fromisoformat(min_d), old_train_end_dt - datetime.timedelta(days=21)
)
