...
b10 = lgb.Booster(model_file=str(settings.ARTIFACTS_DIR / "model_direct_q10.txt")).predict(
    test_df[FEATURE_NAMES]
)
b90 = lgb.Booster(model_file=str(settings.ARTIFACTS_DIR / "model_direct_q90.txt")).predict(
    test_df[FEATURE_NAMES]
)
