...
daily = (
    ...
    .agg({"fog_flag": "max", "temperature": "mean", "humidity": "mean", "precipitation": "sum"})
    .reset_index()
)
...
with db.transaction() as cur:
    cur.execute(
        "SELECT COUNT(*) as cnt FROM station_events WHERE run_date >= '2025-12-01' AND run_date <= '2026-01-31'"
    )
